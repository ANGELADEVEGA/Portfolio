  ...
  return (
    <nav className='bg-black text-white px-8 md:px-16 lg:px-24'>
      <div className='container py-2 flex justify-center md:justify-between items-center'>
        <div className='text-2xl font-bold hidden md:inline'>Angela De Vega</div>
        <div className='space-x-6'>
          <a href="#home" className='hover:text-gray-400'>Home</a>
          <a href="#about" className='hover:text-gray-400'>About Me</a>
          <a href="#experience" className='hover:text-gray-400'>Experience</a>
          <a href="#project" className='hover:text-gray-400'>Projects</a>
          <a href="#ojt" className='hover:text-gray-400'>OJT</a>
          <a href="#education" className='hover:text-gray-400'>Education</a>
          <a href="#seminars" className='hover:text-gray-400'>Seminars</a>
